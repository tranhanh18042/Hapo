    ...
    <body>
        <div class="banner">
            <div class="banner-content">
                ...
                <span class="content-where">at HapoLearn <img src="/app/img/logo_mini.png" alt="LogoMini">
                    !</span>
        ...
        <section class="other">
            ...
            <div class="view-all">
                ...
                <img src="/app/img/arrow.png" class="img-arrow" alt="arrow">
            </div>
        </section>
        <section class="why-hapo-learn">
            <div class="container-why-hapo-learn">
                <img src="/app/img/keyboard.png" class="img-keyboard" alt="keyboard">
                <p class="title">Why HapoLearn?</p>
                <div class="pragraph">
                    <span class="line-pragraph"> <img src="/app/img/check.png" alt="check"> Interactive lessons,
                        "on-the-go"
                ...
                <img src="/app/img/laptop_tablet.png" class="img-laptop-tablet" class="img-fluid" alt="laptop tablet">
            </div>
        </section>
